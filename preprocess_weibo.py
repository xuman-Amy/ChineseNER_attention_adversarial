...
def process_train_data(setting):
    ...
    train_label = []
    train_length = []
    # f = open('../data/ner_zh/ner.train', 'r', encoding='utf-8')
    f = open('./data/weiboNER.conll.train', 'r', encoding='utf-8')
    train_word.append([])
    train_label.append([])
    train_max_len = 0
    while True:
...
def process_test_data(setting):
    ...
    test_label = []
    test_length = []
    # f = open('../data/ner_zh/ner.test', 'r', encoding='utf-8')
    f = open('./data/weiboNER.conll.test', 'r', encoding='utf-8')
    test_word.append([])
    test_label.append([])
    test_max_len = 0
    while True:
